...
AFRAME.registerComponent('supercraft-visualizer', {
  ...
  renderShape: function (index) {
    ...
    if (!thingEl) {
      thingEl = createEntity(this.entityIndex[shape.parentId].attributes);
      this.thingEls[shape.parentId] = thingEl;
      this.el.appendChild(thingEl);
    }

    // Create Shape.
    thingEl.appendChild(createEntity(shape.attributes));
  },
...
module.exports.SHAPE_ROTATIONS = {
  ...
  semicylinder2: new THREE.Euler(Math.PI / 2, 0, 0),
